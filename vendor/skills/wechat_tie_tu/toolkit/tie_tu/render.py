...
def render_preview(plan: TieTuPlan, output_path: str | Path) -> Path:
    ...
    for card in plan.cards:
        ...
        cards.append(f"""
        <section class="card">
          <div class="poster">{image}<span class="index">{card.index:02d}</span></div>
